...
sub class에서 내용을 변경해야 할 상황에서 사용할 수 있다. 즉, super class가 정의한 함수를 덮어씌워 다시 정의하는것이 Overriding이다.  
Overriding 사용시에도 주의할 점이 있는데 메서드이름, 매개변수, 리턴타입이 같아야한다.이건 당연한 얘기일 수 있다.<br>
...
---
 ...
 - Overloading에서는 하나의 메소드로 여러 동작을 할 수 있었고, Overriding에서는 여러 글래스의 다른 기능을 하나의 메소드로 제어할 수 있다.  

> 나도 코드블럭 이쁘게 하고싶은데 잘 안되네.
